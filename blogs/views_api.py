...
class LoginView(APIView):
    def post(self, request):
        ...
        # Removed recaptcha verification since reCAPTCHA is no longer used.
        try:            
    ...
    def post(self, request):
        ...
        try:
            ...
            if check_user:
                ...
                usr.is_active = False
                send_email(usr)
                response['message'] = f'Registration Successful <b>{data.get("firstname")}</b>! Please verify your email address before using the service!'
                response['status'] = 200
        except Exception as e:
            print(e)
